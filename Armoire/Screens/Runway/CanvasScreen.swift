...
class CanvasScreen: UIViewController {
    // MARK: - Properties
...
extension CanvasScreen: CanvasSceneDelegate {
...
extension CanvasScreen: ItemSearchScreenDelegate {
...
extension CanvasScreen: UITextFieldDelegate {
...
struct CanvasScreenPreviews: PreviewProvider {
    static var previews: some View {
        UIViewControllerPreview {
            AMNavigationController(rootViewController: CanvasScreen(runway: Runway(title: "Wedding Outfit 2021")))
        }
